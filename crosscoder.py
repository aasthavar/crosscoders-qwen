...
SAVE_DIR = Path("/home/ubuntu/crosscoders-r1-distill-qwen/checkpoints")
# BASE_DIR = Path("/home/ubuntu/crosscoders-r1-distill-qwen/checkpoints")
...
class CrossCoder(nn.Module):
    ...
    def create_save_dir(self):
        version_list = [
            ...
            for file in list(SAVE_DIR.iterdir()) # this assumes SAVE_DIR already exists
